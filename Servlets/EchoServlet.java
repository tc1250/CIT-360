...
public class EchoServlet extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
         ...
         } else if (age.equals("17")) {
            out.println("<p>Age: 1 to 17 years old</p>");
         } else if (age.equals("39")) {
            out.println("<p>Age: 18 to 39 years old</p>"); 
         } else if (age.equals("65")) {
            out.println("<p>Age: 40 to 65 years old</p>");
         } else if (age.equals("99")) {
            out.println("<p>Age: 66 to 99 years old</p>");   
         } else {
